  ...
  const textContent = [
    {
      ...
      subtitle: "Earn Green",
      description:
        "Discover how CarbonGuard is transforming vehicle emissions to turn them into eco-friendly treasures. Our technology converts vehicle emissions into carbon credits, as we pave the way to a greener world, one mile at a time.",
    },
    {
      title: "Measure Green, ",
      subtitle: "Act Green",
      description:
        "Discover how CarbonGuard allows you to effortlessly measure and monitor carbon emissions, empowering you to make eco-conscious decisions. Gain valuable insights into your carbon footprint and take control of your environmental impact. With CarbonGuard, sustainability becomes a seamless part of your journey.",
    },
    {
      title: "Redefine Green, ",
      subtitle: "Live Green",
      description:
        "Join us in the quest for a greener future. CarbonGuard's innovative platform not only tracks emissions but also calculates your carbon credits. Be a part of the solution to climate change as we transform your emissions into eco-friendly treasures. Our mission is clear: to create a sustainable planet, one mile at a time. Together, we can drive change and make a lasting impact on the environment.",
    },
  ];
